...
<head>
	...
	<link rel="stylesheet" href="assets/css/gafas.css">
			...
			<div class="furniture-container homepage-container">
						...
						<div id="hero" class="homepage-slider3">
							<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
								<div class="full-width-slider">
									<div class="item" style="background-image: url(img/nueva/logo.jpg); ">
										<!-- /.container-fluid -->
									</div><!-- /.item -->
								</div><!-- /.full-width-slider -->

								<div class="full-width-slider">
									<div class="item full-width-slider" style="background-image: url(img/nueva/Ahorro.jpg);">
									</div><!-- /.item -->
								</div><!-- /.full-width-slider -->
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text">En Todos los Modelos 20% de descuento </h6>
										</div>
									</div><!-- .col -->
								</div><!-- /.row -->
				...
				<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
					<div class="more-info-tab clearfix">
						<h3 class="new-product-title pull-left">Modelos Destacados</h3>
						<!-- <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
							<li class="active"><a href="#all" data-toggle="tab">Todos</a></li>
							<li><a href="#books" data-toggle="tab">Camisas</a></li>
							<li><a href="#furniture" data-toggle="tab">Pantalones</a></li>
						</ul> -->
					</div>
										...
										<div class="item item-carousel">
											<div class="products">
												...
												<div class="product">
													...
													<div class="action"><a href="#" class="lnk btn btn-primary">Uniformes de Diario</a></div>
													<!-- <div class="action"><a href="my-cart.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Modelo Uniformes</a></div>
												</div> -->
												</div><!-- /.product -->
										...
										<div class="item item-carousel">
											<div class="products">
												...
												<div class="product">
													...
													<div class="action"><a href="my-cart.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Agregar a carrito</a></div>
												</div>
				...
				<div class="sections prod-slider-small outer-top-small">
					<div class="row">
										...
										<div class="item item-carousel">
											<div class="products">
												...
												<div class="product">
													...
													<div class="action"><a href="#" class="lnk btn btn-primary">Modelo Uniformes</a></div>
													<!-- <div class="action"><a href="my-cart.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Modelo Uniformes</a></div>
												</div> -->
												</div>
											</div>
						...
						<div class="col-md-6">
							<section class="section">
								<h3 class="section-title">Modelo Generales</h3>
								<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
									<?php
										...
										<div class="item item-carousel">
											<div class="products">
												...
												<div class="product">
													...
													<div class="action"><a href="#" class="lnk btn btn-primary">Modelo Uniformes Hombre</a></div>
													<!-- <div class="action"><a href="my-cart.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Modelo Uniformes</a></div>
												</div> -->
												</div>
											</div>
				...
				<section class="section featured-product inner-xs wow fadeInUp">
					<h3 class="section-title">Modas Actuales</h3>
											...
											<div class="row product-micro-row">
												...
												<div class="col col-xs-6">
													<div class="product-info">
														...
														<div class="action"><a href="#" class="lnk btn btn-primary">Nueva Moda</a></div>
													<!-- <div class="action"><a href="my-cart.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Modelo Uniformes</a></div>
												</div> -->
												</div>
												</div><!-- /.col -->
