...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('¿Estás seguro de eliminar tu compra?');</script>";
		}
	}
...
<html lang="es">
	<head>
	    ...
	    <title>Carrito de Comprar</title>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="inicio.php" class="btn btn-upper btn-primary outer-left-xs">Continuar comprando</a>
