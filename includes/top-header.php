...
<?php if(strlen($_SESSION['login'])==0)
    {   ?>
				<li><a href="#"><i class="icon fa fa-user"></i>Bienvenido Alumno<?php echo htmlentities($_SESSION['username']);?></a></li>
				<?php } ?>

					<!-- <li><a href="cuenta.php"><i class="icon fa fa-user"></i>Mi cuenta</a></li> -->
				...
				<?php if(strlen($_SESSION['login'])==0)
    {   ?>
<li><a href="index.php"><i class="icon fa fa-sign-in"></i>Iniciar sesión</a></li>
<?php }
else{ ?>
...
<div class="cnt-block">
				<ul class="list-unstyled list-inline">
					<li class="dropdown dropdown-small">
						...
						<a href="Admin" class="dropdown-toggle" ><span class="icon fa fa-user">Admin</b></a>
					</li>
