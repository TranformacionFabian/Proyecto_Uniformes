...
<h3>Modelos para Uniformes </h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us">Bienvenidos, Te enseñamos y ayudamos a crear tu propio de negocio de Confección y Moda.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">costura@gmail.com</a></span>
                </div>
            </li>
